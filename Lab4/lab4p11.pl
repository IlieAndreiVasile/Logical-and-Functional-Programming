% “Colouring” a map. n countries are given; write a predicate to determine all
% possibilities of colouring n countries with m colours, such that two
% adjacent countries not having the same colour.
